...
export const parentStyle =
  "w-full grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-[4%] md:gap-[8%] lg:gap-[2%] items-center justify-center mt-2";

export const cardsStyle =
  "flex flex-col w-[70%]  md:w-[85%]  lg:w-[95%] h-full items-center justify-center gap-4 bg-[#cbad89] shadow-2xl mx-auto p-5 rounded-2xl ";

function Collection() {
  return (
    <>
      <div
        className="bg-[#ceb18d] pt-6 md:pt-10 pb-[45%] md:pb-[15%] lg:pb-[5%]"
        id="collection"
      >
        ...
        >
          {/* cards */}
          <Link to="/shirts">
            <motion.div className={cardsStyle} variants={childrenVariant}>
              <img
